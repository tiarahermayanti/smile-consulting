            ...
            <div class="header-mobile__bar">
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="<?php echo base_url('index.php/c_home');?>">
                            <img src="<?php echo base_url();?>assets/images/logo.png" alt="Smile Consulting" />
                        </a>
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            <a class="js-arrow" href="<?php echo base_url('index.php/c_home');?>">
                                <i class="fas fa-tachometer-alt"></i>Dashboard</a>
                            
                        </li>
                       
                        <li>
                            <a href="<?php echo base_url('index.php/c_home/listUser');?>">
                                  ...
                                  <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            ...
                                            <a class="js-acc-btn" href="#"><?php echo $this->session->userdata('user_name');?></a>
                                        </div>
